...
sudo apt-get install git gcc wget gdebi-core python3 python3-pip python3-venv python3-pil python3-lxml python3-ldap3 python3-wheel python3-suds libxslt1-dev libzip-dev libsasl2-dev python3-setuptools python3-pypdf2 python3-dev libxml2-dev zlib1g-dev libsasl2-dev libldap2-dev build-essential libssl-dev libffi-dev libmysqlclient-dev libjpeg-dev libpq-dev libjpeg8-dev liblcms2-dev libblas-dev libatlas-base-dev libxmlsec1-dev node-less -y
...
sudo apt-get install nodejs node-less npm -y
...
if [ $INSTALL_WKHTMLTOPDF = "True" ]; then
  ...
  sudo apt-get install fontconfig xfonts-base -y
  cd /tmp
